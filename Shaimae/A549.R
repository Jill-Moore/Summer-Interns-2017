...
data <- read.table("~/Desktop/REST analysis/Top 10000 Peaks Graphs/A549data.txt")
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/A549-REST.pdf")
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/A549-CTCF.pdf")
