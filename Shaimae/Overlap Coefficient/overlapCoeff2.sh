...
# Note: here, the denominator of the overlap coefficient is always the number of lines in the file kept constant, file A
...
do
	...
	# Calculate the overlap coefficient
        overlapCoeff=$( awk "BEGIN {printf \"%.3f\", $numOverlap / $numLinesA } ")
        echo $overlapCoeff
done
