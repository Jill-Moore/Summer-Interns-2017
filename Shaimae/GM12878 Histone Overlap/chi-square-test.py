...
# Python script to find chi square values for GM12878 cRE-histone mark overlaps; goal is to look for any DNase Group 2 enrichment in histone marks.

# Open and load all the data files (which are the results of the bedtools intersect GM12878 cRE-histone mark overlaps)
