...
data <- read.table("~/Desktop/REST analysis/Top 10000 Peaks Graphs/GM12878data.txt")

# Set variables
peaks <- c(500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500)
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/GM12878-REST.pdf")
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/GM12878-CTCF.pdf")
