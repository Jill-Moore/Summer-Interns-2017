...
data <- read.table("~/Desktop/REST analysis/Top 10000 Peaks Graphs/HEK293data.txt")
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/HEK293-REST.pdf")
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/HEK293-CTCF.pdf")
