...
data <- read.table("~/Desktop/REST analysis/Top 10000 Peaks Graphs/K562-Snyderdata.txt")
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/K562-Snyder-REST.pdf")

ggplot(data, aes(x=peaks, y=percentsREST)) + geom_point(color = "dodgerblue") + 
  geom_line(color = "dodgerblue3") + 
  labs(title = "K562 (Snyder)",
...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/K562-Snyder-CTCF.pdf")
