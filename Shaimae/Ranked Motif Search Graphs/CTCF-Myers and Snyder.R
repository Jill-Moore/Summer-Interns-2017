...
# Initialize image
pdf("~/Desktop/REST analysis/Top 10000 Peaks Graphs/CTCF-Myers-Snyder.pdf")

ggplot(data, aes(x=peaks)) + 
  geom_point(aes(y=CTCF_Myers, color = "dodgerblue")) + 
  geom_point(aes(y=CTCF_Snyder, color = "chocolate1")) +
  geom_line(y=CTCF_Myers, color = "dodgerblue3") +
  geom_line(y=CTCF_Snyder, color = "chocolate3") +
  labs(title = "CTCF",
       subtitle = "Percent of Myers and Snyder REST ChIP-seq peaks containing the CTCF motif",
