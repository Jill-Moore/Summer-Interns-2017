...
K562_E_overlap <- read.table("cRE_K562+E.txt")
#K562_E_overlap <- data.matrix(K562_E_overlap)

K562_E_noOverlap <- read.table("cRE_K562-E.txt")
...
pdf("~/Desktop/Density plots/K562-Enhancer+-POL2-cRE.pdf")
...
my_text1 <- "+POL2"
my_text2 <- "-POL2"
my_grob1 <- grid.text(my_text1, x = 0.7, y = 0.5, 
