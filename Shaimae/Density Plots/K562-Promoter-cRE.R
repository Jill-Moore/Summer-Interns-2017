...
K562_P_overlap <- read.table("cRE_K562+P.txt")
#K562_P_overlap <- data.matrix(K562_P_overlap)

K562_P_noOverlap <- read.table("cRE_K562-P.txt")
...
pdf("~/Desktop/Density plots/K562-Promoter+-POL2-cRE.pdf")
...
my_text1 <- "+POL2"
my_text2 <- "-POL2"
my_grob1 <- grid.text(my_text1, x = 0.83, y = 0.35, 
                      gp = gpar(col = "blue2", fontsize = 12))
my_grob2 <- grid.text(my_text2, x = 0.35, y = 0.7,
