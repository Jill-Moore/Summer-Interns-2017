...
GM12878_E_overlap <- read.table("TSS_GM12878+E.txt")
#GM12878_E_overlap <- data.matrix(GM12878_E_overlap)

GM12878_E_noOverlap <- read.table("TSS_GM12878-E.txt")
...
pdf("~/Desktop/Density plots/GM12878-Enhancer+-POL2-TSS.pdf")
...
my_text1 <- "+POL2"
my_text2 <- "-POL2"
my_grob1 <- grid.text(my_text1, x = 0.56, y = 0.8, 
                      gp = gpar(col = "blue2", fontsize = 12))
my_grob2 <- grid.text(my_text2, x = 0.855, y = 0.4,
