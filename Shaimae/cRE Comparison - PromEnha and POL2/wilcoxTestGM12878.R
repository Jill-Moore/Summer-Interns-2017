...
df = read.table("./chiSquare-WilcoxData/distancesToTSSoverlap_Promoter-POL2_GM12878.txt")
df2 = read.table("./chiSquare-WilcoxData/distancesToTSSnoOverlap_Promoter-POL2_GM12878.txt")
...
df3 = read.table("./chiSquare-WilcoxData/distancesToTSSoverlap_Enhancer-POL2_GM12878.txt")
df4 = read.table("./chiSquare-WilcoxData/distancesToTSSnoOverlap_Enhancer-POL2_GM12878.txt")
...
df5 = read.table("./chiSquare-WilcoxData/cRElengthsoverlap_Promoter-POL2_GM12878.txt")
df6 = read.table("./chiSquare-WilcoxData/cRElengthsnoOverlap_Promoter-POL2_GM12878.txt")
...
df7 = read.table("./chiSquare-WilcoxData/cRElengthsoverlap_Enhancer-POL2_GM12878.txt")
df8 = read.table("./chiSquare-WilcoxData/cRElengthsnoOverlap_Enhancer-POL2_GM12878.txt")
