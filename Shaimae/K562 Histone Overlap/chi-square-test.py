...
# Python script to find chi square values for K562 cRE-histone mark overlaps; goal is to look for any DNase Group 2 enrichment in histone marks.

# Open and load all the data files (which are the results of the bedtools intersect K562 cRE-histone mark overlaps)
...
# Find the number of histone marks there are (this number will be used as the range in the for loop)
numberOfHistoneMarks=len(DNase2)
...
totalDNase1=40553
totalDNase2=6293
totalInactive=1183959

for i in range(0, numberOfHistoneMarks):
